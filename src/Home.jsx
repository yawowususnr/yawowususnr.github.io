            ...
            <div className="sm:w-5/6 md:w-[780px] lg:w-[780px] mt-8">
                <div className="my-10 flex items-end">
                    <div className="w-2/3">
                        ...
                        <div className="text-graytext text-xl">
                            ...
                            projects and writes about life, code, design, and
                            more. Welcome to my digital diary.
                        </div>
                    </div>
                    <div>
                        <img
                ...
                <div className="mt-32">
                    ...
                    <p className="mt-5">
                        ...
                        dava visualisation, and distributed systems. Built with
                        an intention to demonstrate my technical skills, this
                        site is powered by a combination of cutting-edge
                        technologies.
                    </p>
                    ...
                    <div className=" h w-full bg-cardalts rounded-lg bg-card border border-cardbg flex items-center shadow-md mb-10">
                        <div className="w-2/3 text-md">
                            <p className="m-4 text-graytext">
                                My work showcases skills in frontend
                                development, backend APIs, data analysis, and
                    ...
                    <footer className="flex justify-center gap-6 mb-10">
                        ...
                        <a
                            href="https://drive.google.com/file/d/1wT9FpdayMNCNNJ6uPAzclBqauLorYkBT/view?usp=sharing"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
